...
function handleHomeClick() {
    // Redirect to the HTML file inside the folder
    window.location.href = 'home/home.html'; // Adjust 'folder/home.html' to your folder structure
}

// Get the "Home" link element by its id and attach the click event listener
var homeLink = document.getElementById('home');
homeLink.addEventListener('click', handleHomeClick);

function handleAboutClick() {
    // Redirect to the HTML file inside the folder
    window.location.href = 'about/about.html'; // Adjust 'folder/home.html' to your folder structure
}

// Get the "Home" link element by its id and attach the click event listener
var homeLink = document.getElementById('about');
homeLink.addEventListener('click', handleAboutClick);

function handleLoginClick() {
    // Redirect to the HTML file inside the folder
    window.location.href = 'login/login.html'; // Adjust 'folder/home.html' to your folder structure
}

// Get the "Home" link element by its id and attach the click event listener
var homeLink = document.getElementById('login');
homeLink.addEventListener('click', handleLoginClick);